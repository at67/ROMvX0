...
namespace Assembler
{
    ...
    void initialiseOpcodes(void)
    {
        ...
        _asmOpcodes["FREQZI"] = {0x2F, 0x27, ThreeBytes, vCpu};
        ...
        _asmOpcodes["MODZI" ] = {0x2F, 0x32, ThreeBytes, vCpu};
        ...
        _vcpuOpcodes[0x1C] = {0x1C, 0x00, ThreeBytes, vCpu, "LOKEQI"};
        _vcpuOpcodes[0x1F] = {0x1F, 0x00, TwoBytes,   vCpu, "CMPHS" };
        _vcpuOpcodes[0x21] = {0x21, 0x00, TwoBytes,   vCpu, "LDW"   };
        _vcpuOpcodes[0x23] = {0x23, 0x00, TwoBytes,   vCpu, "PEEK+" };
        ...
        _vcpuOpcodes[0x32] = {0x32, 0x00, ThreeBytes, vCpu, "DBNE"  };
        _vcpuOpcodes[0x37] = {0x37, 0x00, ThreeBytes, vCpu, "DOKEI" };
        _vcpuOpcodes[0x39] = {0x39, 0x00, TwoBytes,   vCpu, "PEEKV" };
        _vcpuOpcodes[0x3B] = {0x3B, 0x00, TwoBytes,   vCpu, "DEEKV" };
        _vcpuOpcodes[0x3D] = {0x3D, 0x00, FiveBytes,  vCpu, "LOKEI" };
        _vcpuOpcodes[0x42] = {0x42, 0x00, ThreeBytes, vCpu, "ADDVI" };
        _vcpuOpcodes[0x44] = {0x44, 0x00, ThreeBytes, vCpu, "SUBVI" };
        _vcpuOpcodes[0x46] = {0x46, 0x00, TwoBytes,   vCpu, "DOKE+" };
        ...
        _vcpuOpcodes[0x5B] = {0x5B, 0x00, ThreeBytes, vCpu, "MOVQW" };
        _vcpuOpcodes[0x5E] = {0x5E, 0x00, TwoBytes,   vCpu, "ST"    };
        _vcpuOpcodes[0x60] = {0x60, 0x00, TwoBytes,   vCpu, "DEEK+" };
        ...
        _vcpuOpcodes[0x9E] = {0x9E, 0x00, ThreeBytes, vCpu, "ANDBK" };
        _vcpuOpcodes[0xA0] = {0xA0, 0x00, ThreeBytes, vCpu, "ORBK"  };
        _vcpuOpcodes[0xA2] = {0xA2, 0x00, ThreeBytes, vCpu, "XORBK" };
        ...
        _vcpuOpcodes[0xD1] = {0xD1, 0x00, TwoBytes,   vCpu, "POKE+" };
        ...
        _vcpuOpcodes[0x2F27] = {0x2F, 0x27, ThreeBytes, vCpu, "FREQZI"};
        _vcpuOpcodes[0x2F2A] = {0x2F, 0x2A, ThreeBytes, vCpu, "VOLM"  };
        _vcpuOpcodes[0x2F2C] = {0x2F, 0x2C, ThreeBytes, vCpu, "VOLA"  };
        _vcpuOpcodes[0x2F2F] = {0x2F, 0x2F, ThreeBytes, vCpu, "MODA"  };
        _vcpuOpcodes[0x2F32] = {0x2F, 0x32, ThreeBytes, vCpu, "MODZI" };
        _vcpuOpcodes[0x2F34] = {0x2F, 0x34, ThreeBytes, vCpu, "SMPCPY"};
        _vcpuOpcodes[0x2F37] = {0x2F, 0x37, ThreeBytes, vCpu, "CMPWS" };
        _vcpuOpcodes[0x2F39] = {0x2F, 0x39, ThreeBytes, vCpu, "CMPWU" };
        _vcpuOpcodes[0x2F3B] = {0x2F, 0x3B, ThreeBytes, vCpu, "LEEKA" };
        _vcpuOpcodes[0x2F3D] = {0x2F, 0x3D, ThreeBytes, vCpu, "LOKEA" };
        _vcpuOpcodes[0x2F3F] = {0x2F, 0x3F, ThreeBytes, vCpu, "FEEKA" };
        _vcpuOpcodes[0x2F42] = {0x2F, 0x42, ThreeBytes, vCpu, "FOKEA" };
        _vcpuOpcodes[0x2F44] = {0x2F, 0x44, ThreeBytes, vCpu, "MEEKA" };
        _vcpuOpcodes[0x2F46] = {0x2F, 0x46, ThreeBytes, vCpu, "MOKEA" };
        _vcpuOpcodes[0x2F48] = {0x2F, 0x48, ThreeBytes, vCpu, "LSRVL" };
        _vcpuOpcodes[0x2F4B] = {0x2F, 0x4B, ThreeBytes, vCpu, "LSLVL" };
        _vcpuOpcodes[0x2F4E] = {0x2F, 0x4E, ThreeBytes, vCpu, "INCL"  };
        _vcpuOpcodes[0x2F51] = {0x2F, 0x51, ThreeBytes, vCpu, "DECL"  };
        ...
        _vcpuOpcodes[0xC725] = {0xC7, 0x25, FourBytes, vCpu, "LDPX"  };
        _vcpuOpcodes[0xC728] = {0xC7, 0x28, FourBytes, vCpu, "STPX"  };
        _vcpuOpcodes[0xC72B] = {0xC7, 0x2B, FourBytes, vCpu, "CONDI" };
        _vcpuOpcodes[0xC72D] = {0xC7, 0x2D, FourBytes, vCpu, "CONDB" };
        _vcpuOpcodes[0xC730] = {0xC7, 0x30, FourBytes, vCpu, "CONDIB"};
        _vcpuOpcodes[0xC733] = {0xC7, 0x33, FourBytes, vCpu, "CONDBI"};
        _vcpuOpcodes[0xC735] = {0xC7, 0x35, FourBytes, vCpu, "XCHGW" };
        _vcpuOpcodes[0xC738] = {0xC7, 0x38, FourBytes, vCpu, "OSCPX" };
        _vcpuOpcodes[0xC73A] = {0xC7, 0x3A, FourBytes, vCpu, "SWAPB" };
        _vcpuOpcodes[0xC73D] = {0xC7, 0x3D, FourBytes, vCpu, "SWAPW" };
        _vcpuOpcodes[0xC740] = {0xC7, 0x40, FourBytes, vCpu, "NEEKA" };
        _vcpuOpcodes[0xC743] = {0xC7, 0x43, FourBytes, vCpu, "NOKEA" };
        _vcpuOpcodes[0xC746] = {0xC7, 0x46, FourBytes, vCpu, "ADDVL" };
        _vcpuOpcodes[0xC749] = {0xC7, 0x49, FourBytes, vCpu, "SUBVL" };
        _vcpuOpcodes[0xC74C] = {0xC7, 0x4C, FourBytes, vCpu, "ANDVL" };
        _vcpuOpcodes[0xC74F] = {0xC7, 0x4F, FourBytes, vCpu, "ORVL"  };
        _vcpuOpcodes[0xC752] = {0xC7, 0x52, FourBytes, vCpu, "XORVL" };
        _vcpuOpcodes[0xC755] = {0xC7, 0x55, FourBytes, vCpu, "JEQL"  };
        _vcpuOpcodes[0xC758] = {0xC7, 0x58, FourBytes, vCpu, "JNEL"  };
        _vcpuOpcodes[0xC75B] = {0xC7, 0x5B, FourBytes, vCpu, "JLTL"  };
        _vcpuOpcodes[0xC75E] = {0xC7, 0x5E, FourBytes, vCpu, "JGTL"  };
        _vcpuOpcodes[0xC761] = {0xC7, 0x61, FourBytes, vCpu, "JLEL"  };
        _vcpuOpcodes[0xC764] = {0xC7, 0x64, FourBytes, vCpu, "JGEL"  };
        _vcpuOpcodes[0xC767] = {0xC7, 0x67, FourBytes, vCpu, "ANDBI" };
        _vcpuOpcodes[0xC76A] = {0xC7, 0x6A, FourBytes, vCpu, "ORBI"  };
        _vcpuOpcodes[0xC76D] = {0xC7, 0x6D, FourBytes, vCpu, "XORBI" };
    ...
    bool getVCpuMnemonic(uint16_t address, uint8_t opcode, uint8_t operand0, uint8_t operand1, uint8_t operand2, uint8_t operand3, ByteSize& byteSize, char* mnemonic)
    {
        ...
        if(opcode == OPCODE_V_PREFX1  ||  opcode == OPCODE_V_PREFX2  ||  opcode == OPCODE_V_PREFX3)
        {
            ...
            if((opcode == OPCODE_V_PREFX3)  &&  (operand0 == OPCODE_V_XCHGB  ||  operand0 == OPCODE_V_MOVW   ||  operand0 == OPCODE_V_LDPX    ||  operand0 == OPCODE_V_STPX    ||
                                                 operand0 == OPCODE_V_CONDI  ||  operand0 == OPCODE_V_CONDB  ||  operand0 == OPCODE_V_CONDIB  ||  operand0 == OPCODE_V_CONDBI  ||
                                                 operand0 == OPCODE_V_XCHGW  ||  operand0 == OPCODE_V_OSCPX  ||  operand0 == OPCODE_V_SWAPB   ||  operand0 == OPCODE_V_SWAPW   ||
                                                 operand0 == OPCODE_V_NEEKA  ||  operand0 == OPCODE_V_NOKEA  ||  operand0 == OPCODE_V_ADDVL   ||  operand0 == OPCODE_V_SUBVL   ||
                                                 operand0 == OPCODE_V_ANDVL  ||  operand0 == OPCODE_V_ORVL   ||  operand0 == OPCODE_V_XORVL   ||  operand0 == OPCODE_V_ANDBI   ||
                                                 operand0 == OPCODE_V_ORBI   ||  operand0 == OPCODE_V_XORBI))
            {
        ...
        if((_vcpuOpcodes.find(opcode) == _vcpuOpcodes.end()  &&  opcode != OPCODE_V_BCC)  ||
        ...
        {
            opcode = operand0;
            if(_vcpuOpcodes.find(opcode) == _vcpuOpcodes.end())
            {
                sprintf(mnemonic, "%04x  $%02x", address, opcode);
                return false;
            }
        ...
        // MOVQB MOVB MOVQW ADDBI SUBBI ANDBK ORBK XORBK CMPI ADDVI SUBVI opcodes
        if(opcode == OPCODE_V_MOVQB  ||  opcode == OPCODE_V_MOVB   ||  opcode == OPCODE_V_MOVQW  ||  opcode == OPCODE_V_ADDBI  ||  opcode == OPCODE_V_SUBBI  ||  opcode == OPCODE_V_ANDBK  ||
           opcode == OPCODE_V_ORBK   ||  opcode == OPCODE_V_XORBK  ||  opcode == OPCODE_V_CMPI   ||  opcode == OPCODE_V_ADDVI  ||  opcode == OPCODE_V_SUBVI)
        {
        ...
        // DOKEI opcode
        else if(opcode == OPCODE_V_DOKEI)
        {
            sprintf(mnemonic, "%04x  %-6s $%02x%02x", address, _vcpuOpcodes[opcode]._mnemonic.c_str(), operand0, operand1);
        }
        // LOKEQI opcode
        else if(opcode == OPCODE_V_LOKEQI)
        {
            sprintf(mnemonic, "%04x  %-6s $%02x%02x", address, _vcpuOpcodes[opcode]._mnemonic.c_str(), operand0, operand1);
        }
        // LOKEI opcode
        else if(opcode == OPCODE_V_LOKEI)
        {
            sprintf(mnemonic, "%04x  %-6s $%02x%02x%02x%02x", address, _vcpuOpcodes[opcode]._mnemonic.c_str(), operand0, operand1, operand2, operand3);
        }
        // HALT opcode
        ...
        else
        {
            switch(byteSize)
            {
                ...
                case ThreeBytes:
                {
                    if(foundBranch)
                    {
                        sprintf(mnemonic, "%04x  %-6s $%02x", address, _vcpuOpcodes[opcode]._mnemonic.c_str(), uint8_t(operand1 + BRANCH_ADJUSTMENT));
                    }
                    else
                    {
                        sprintf(mnemonic, "%04x  %-6s $%02x%02x", address, _vcpuOpcodes[opcode]._mnemonic.c_str(), operand1, operand0);
                ...
                if(parse == CodePass)
                {
                    ...
                    switch(outputSize)
                    {
                        ...
                        case ThreeBytes:
                        {
                            ...
                            else if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_ANDBK)
                            {
                                if(tokens.size() < 3)
                                {
                                ...
                                instruction._operand0 = equates[1]; // native code expects the operands swapped for ANDBK
                                instruction._operand1 = equates[0];
                                _instructions.push_back(instruction);
                                if(!checkInvalidAddress(ParseType(parse), _currentAddress, uint16_t(outputSize), instruction, lineToken, filename, _lineNumber)) return false;
                            }
                            // Special case ORBK as it has multiple parseable tokens
                            else if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_ORBK)
                            {
                                if(tokens.size() < 3)
                                {
                                ...
                                instruction._operand0 = equates[1]; // native code expects the operands swapped for ORBK
                                instruction._operand1 = equates[0];
                                _instructions.push_back(instruction);
                                if(!checkInvalidAddress(ParseType(parse), _currentAddress, uint16_t(outputSize), instruction, lineToken, filename, _lineNumber)) return false;
                            }
                            // Special case XORBK as it has multiple parseable tokens
                            else if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_XORBK)
                            {
                                if(tokens.size() < 3)
                                {
                                ...
                                instruction._operand0 = equates[1]; // native code expects the operands swapped for XORBK
                                instruction._operand1 = equates[0];
                                _instructions.push_back(instruction);
                                if(!checkInvalidAddress(ParseType(parse), _currentAddress, uint16_t(outputSize), instruction, lineToken, filename, _lineNumber)) return false;
                            }
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if(opcodeType == vCpu  &&  (opcode0 == OPCODE_V_DOKEI  ||  opcode0 == OPCODE_V_LOKEQI)) std::swap(instruction._operand0, instruction._operand1);
                        ...
                        case FourBytes:
                        {
                            ...
                            if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_PREFX3)
                            {
                                ...
                                // Special case LDPX as it has multiple parseable tokens
                                else if(opcode1 == OPCODE_V_LDPX)
                                {
                                    if(tokens.size() < 3)
                                    {
                                        Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'LDPX <address zero page var>, <colour zero page var>' expects 2 parameters '%s'\n", filename.c_str(), _lineNumber+1,
                                                                                                                                                                                                        tokens[tokenIndex].c_str());
                                        return false;
                                    }
                                    ...
                                    for(int i=0; i<2; i++)
                                    {
                                        ...
                                        if(tokIdx >= int(tokens.size()))
                                        {
                                            Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'LDPX' syntax error in '%s'\n", filename.c_str(), _lineNumber+1, lineToken._text.c_str());
                                            return false;
                                        }
                                        ...
                                        if(!operandValid)
                                        {
                                            Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'LDPX' invalid equate/literal '%s'\n", filename.c_str(), _lineNumber+1, tokens[tokIdx].c_str());
                                            return false;
                                        }
                                    }
                                ...
                                // Special case STPX as it has multiple parseable tokens
                                else if(opcode1 == OPCODE_V_STPX)
                                {
                                    if(tokens.size() < 3)
                                    {
                                        Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'STPX <address zero page var>, <colour zero page var>' expects 2 parameters '%s'\n", filename.c_str(), _lineNumber+1,
                                                                                                                                                                                                        tokens[tokenIndex].c_str());
                                        return false;
                                    }
                                    ...
                                    for(int i=0; i<2; i++)
                                    {
                                        ...
                                        if(tokIdx >= int(tokens.size()))
                                        {
                                            Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'STPX' syntax error in '%s'\n", filename.c_str(), _lineNumber+1, lineToken._text.c_str());
                                            return false;
                                        }
                                        ...
                                        if(!operandValid)
                                        {
                                            Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'STPX' invalid equate/literal '%s'\n", filename.c_str(), _lineNumber+1, tokens[tokIdx].c_str());
                                            return false;
                                        }
                                    }
                                ...
                                // Special case CONDI as it has multiple parseable tokens
                                else if(opcode1 == OPCODE_V_CONDI)
                                {
                                    if(tokens.size() < 3)
                                    {
                                        Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'CONDI <immediate 0>, <immediate 1>' expects 2 parameters '%s'\n", filename.c_str(), _lineNumber+1,
                                                                                                                                                                                      tokens[tokenIndex].c_str());
                                        return false;
                                    }
                                    ...
                                    for(int i=0; i<2; i++)
                                    {
                                        ...
                                        if(tokIdx >= int(tokens.size()))
                                        {
                                            Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'CONDI' syntax error in '%s'\n", filename.c_str(), _lineNumber+1, lineToken._text.c_str());
                                            return false;
                                        }
                                        ...
                                        if(!operandValid)
                                        {
                                            Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'CONDI' invalid equate/literal '%s'\n", filename.c_str(), _lineNumber+1, tokens[tokIdx].c_str());
                                            return false;
                                        }
                                    }
                                ...
                                // Special case CONDB as it has multiple parseable tokens
                                else if(opcode1 == OPCODE_V_CONDB)
                                {
                                    if(tokens.size() < 3)
                                    {
                                        Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'CONDB <src zero page var>, <dst zero page var>' expects 2 parameters '%s'\n", filename.c_str(), _lineNumber+1,
                                                                                                                                                                                                  tokens[tokenIndex].c_str());
                                        return false;
                                    }
                                    ...
                                    for(int i=0; i<2; i++)
                                    {
                                        ...
                                        if(tokIdx >= int(tokens.size()))
                                        {
                                            Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'CONDB' syntax error in '%s'\n", filename.c_str(), _lineNumber+1, lineToken._text.c_str());
                                            return false;
                                        }
                                        ...
                                        if(!operandValid)
                                        {
                                            Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'CONDB' invalid equate/literal '%s'\n", filename.c_str(), _lineNumber+1, tokens[tokIdx].c_str());
                                            return false;
                                        }
                                    }
                        ...
                        case FiveBytes:
                        {
                            ...
                            // LOKEI has it's operands swapped
                            if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_LOKEI)
                            {
