'normally blits must be horizontally divisible by 6, but by specifying an overlap value the last column
'of a blit can be pushed closer to the rest of the blit, (works with flipped blits as well)
...
'LUT containing ghost blit frames
...
'LUT containing ghost blit altrenate frames
