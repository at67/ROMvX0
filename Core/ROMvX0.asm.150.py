...
maxTicks28 = 28//2               # Duration of previous ROM vCPU's slowest virtual opcode (ticks)
...
label('videoA')
ld('videoB')                    #25 1st scanline of 4 (always visible)
st([nextVideo])                 #26
ld([xout])                      #27
...
label('videoB')
ld('videoC')                    #25 2nd scanline of 4
st([nextVideo])                 #26
ld([xout])                      #27
ld(syncBits,OUT)                #28 End horizontal pulse
ld(videoTable>>8,Y)             #29
...
adda([Y,X])                     #33
bra([videoModeB])               #34
st([frameX],X)                  #35 Store in RAM and X
...
label('videoC')
ld('videoD')                    #25 3rd scanline of 4
st([nextVideo])                 #26
ld([xout])                      #27
ld(syncBits,OUT)                #28 End horizontal pulse
ld([sample])                    #29 New sound sample is ready (didn't fit in the audio loop)
ora([audioBitMask])             #30 configure 4/6/8bit audio
anda([xoutMask])                #31
...
ld([videoY])                    #29
suba((120-1)*2)                 #30
beq('.lastpixels#33')           #31
ld([frameX],X)                  #32 4th scanline of 4
adda(120*2)                     #33 More pixel lines to go
bra([videoModeD])               #34
st([videoY])                    #35

label('.lastpixels#33')
ld('videoE')                    #33 No more pixel lines to go
bra([videoModeD])               #34
st([nextVideo])                 #35
...
#label('videoF')
#ld([videoSync1])                #27 Completely black pixel line
#ld(syncBits,OUT)                #28 End horizontal pulse
#adda(0x80)                      #30
#st([videoSync1],X)              #31
#ld([frameX])                    #32
...
label('nopixels')
runVcpu(200-36, 'ABCD line 40-520',
  returnTo=0x1ff)               #36 Application interpreter (black scanlines)
