...
# SDCard Development using "ROM v5" as a foundation bespoke for bmwtcu
SDCARD_bmwtcu.rom: Core/* Apps/*/* makefile interface.json
	python3 Core/SDCARD_bmwtcu.asm.py\
		SYS_Loader_vX.py\
...
SDCARD.rom: Core/* Apps/*/* Makefile interface.json
	python3 Core/SDCARD.asm.py\
		SYS_Loader_vX.py\
