...
namespace Assembler
{
    ...
    void initialiseOpcodes(void)
    {
        ...
        _asmOpcodes["MOVQW" ] = {0x1C, 0x00, ThreeBytes, vCpu};
        _asmOpcodes["ARRW"  ] = {0x1F, 0x00, ThreeBytes, vCpu};
        _asmOpcodes["LDW"   ] = {0x21, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["PEEKV+"] = {0x23, 0x00, TwoBytes,   vCpu};
        ...
        _asmOpcodes["ARRVW" ] = {0x3D, 0x00, FourBytes,  vCpu};
        _asmOpcodes["LDARRW"] = {0x3F, 0x00, FourBytes,  vCpu};
        _asmOpcodes["ADDVI" ] = {0x42, 0x00, ThreeBytes, vCpu};
        _asmOpcodes["SUBVI" ] = {0x44, 0x00, ThreeBytes, vCpu};
        _asmOpcodes["DEEKV+"] = {0x46, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["NOTB"  ] = {0x48, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["DJGE"  ] = {0x4A, 0x00, FourBytes,  vCpu};
        _asmOpcodes["LOKEQI"] = {0x4D, 0x00, ThreeBytes, vCpu};
        _asmOpcodes["STWM"  ] = {0x4F, 0x00, ThreeBytes, vCpu};
        _asmOpcodes["STARRW"] = {0x51, 0x00, FourBytes,  vCpu};
        _asmOpcodes["LDARRB"] = {0x53, 0x00, FourBytes,  vCpu};
        _asmOpcodes["STARRB"] = {0x55, 0x00, FourBytes,  vCpu};
        _asmOpcodes["STARRI"] = {0x57, 0x00, FiveBytes,  vCpu};
        _asmOpcodes["LDI"   ] = {0x59, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["PEEKV" ] = {0x5B, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["ST"    ] = {0x5E, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["DOKEV+"] = {0x60, 0x00, TwoBytes,   vCpu};
        ...
        _asmOpcodes["LDWM"  ] = {0x72, 0x00, ThreeBytes, vCpu};
        ...
        _asmOpcodes["INCWA" ] = {0x95, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["POKEA+"] = {0x97, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["ADDW"  ] = {0x99, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["LDNI"  ] = {0x9C, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["DBNE"  ] = {0x9E, 0x00, ThreeBytes, vCpu};
        _asmOpcodes["DEEKR" ] = {0xA0, 0x00, TwoBytes,   vCpu};
        _asmOpcodes["PACKVW"] = {0xA2, 0x00, ThreeBytes, vCpu};
        ...
        _asmOpcodes["POKEV+"] = {0xD1, 0x00, TwoBytes,   vCpu};
        ...
        _asmOpcodes["DECWA" ] = {0xDD, 0x00, TwoBytes,   vCpu};
        ...
        _asmOpcodes["XLA"   ] = {0xB1, 0x17, TwoBytes, vCpu};
        _asmOpcodes["RANDW" ] = {0xB1, 0x2F, TwoBytes, vCpu};
        _asmOpcodes["LDPX"  ] = {0xB1, 0x31, TwoBytes, vCpu};
        _asmOpcodes["ABSW"  ] = {0xB1, 0x33, TwoBytes, vCpu};
        _asmOpcodes["SGNW"  ] = {0xB1, 0x36, TwoBytes, vCpu};
        _asmOpcodes["MULB3" ] = {0xB1, 0x39, TwoBytes, vCpu};
        _asmOpcodes["MULB5" ] = {0xB1, 0x3b, TwoBytes, vCpu};
        _asmOpcodes["MULB6" ] = {0xB1, 0x3d, TwoBytes, vCpu};
        _asmOpcodes["MULB7" ] = {0xB1, 0x3f, TwoBytes, vCpu};
        ...
        _asmOpcodes["FREQI" ] = {0x2F, 0x27, ThreeBytes, vCpu};
        _asmOpcodes["VOLM"  ] = {0x2F, 0x29, ThreeBytes, vCpu};
        _asmOpcodes["VOLA"  ] = {0x2F, 0x2C, ThreeBytes, vCpu};
        _asmOpcodes["MODA"  ] = {0x2F, 0x2F, ThreeBytes, vCpu};
        _asmOpcodes["MODI"  ] = {0x2F, 0x32, ThreeBytes, vCpu};
        _asmOpcodes["SMPCPY"] = {0x2F, 0x34, ThreeBytes, vCpu};
        _asmOpcodes["CMPHS" ] = {0x2F, 0x37, ThreeBytes, vCpu};
        _asmOpcodes["CMPHU" ] = {0x2F, 0x3A, ThreeBytes, vCpu};
        _asmOpcodes["LEEKA" ] = {0x2F, 0x3D, ThreeBytes, vCpu};
        _asmOpcodes["LOKEA" ] = {0x2F, 0x3F, ThreeBytes, vCpu};
        _asmOpcodes["FEEKA" ] = {0x2F, 0x41, ThreeBytes, vCpu};
        _asmOpcodes["FOKEA" ] = {0x2F, 0x43, ThreeBytes, vCpu};
        _asmOpcodes["MEEKA" ] = {0x2F, 0x45, ThreeBytes, vCpu};
        _asmOpcodes["MOKEA" ] = {0x2F, 0x47, ThreeBytes, vCpu};
        _asmOpcodes["LSRVL" ] = {0x2F, 0x49, ThreeBytes, vCpu};
        _asmOpcodes["LSLVL" ] = {0x2F, 0x4C, ThreeBytes, vCpu};
        _asmOpcodes["INCL"  ] = {0x2F, 0x4F, ThreeBytes, vCpu};
        _asmOpcodes["DECL"  ] = {0x2F, 0x52, ThreeBytes, vCpu};
        _asmOpcodes["STPX"  ] = {0x2F, 0x54, ThreeBytes, vCpu};
        _asmOpcodes["FLT6X8"] = {0x2F, 0x57, ThreeBytes, vCpu};
        _asmOpcodes["FLT4X6"] = {0x2F, 0x5A, ThreeBytes, vCpu};
        _asmOpcodes["PRN4X6"] = {0x2F, 0x5C, ThreeBytes, vCpu};
        _asmOpcodes["VTBL"  ] = {0x2F, 0x5E, ThreeBytes, vCpu};
        _asmOpcodes["OSCZ"  ] = {0x2F, 0x61, ThreeBytes, vCpu};
        ...
        _asmOpcodes["FNT6X8"] = {0xC7, 0x25, FourBytes, vCpu};
        _asmOpcodes["FNT4X6"] = {0xC7, 0x27, FourBytes, vCpu};
        _asmOpcodes["CONDII"] = {0xC7, 0x29, FourBytes, vCpu};
        _asmOpcodes["CONDBB"] = {0xC7, 0x2B, FourBytes, vCpu};
        _asmOpcodes["CONDIB"] = {0xC7, 0x2E, FourBytes, vCpu};
        _asmOpcodes["CONDBI"] = {0xC7, 0x31, FourBytes, vCpu};
        _asmOpcodes["XCHGW" ] = {0xC7, 0x33, FourBytes, vCpu};
        _asmOpcodes["OSCPX" ] = {0xC7, 0x36, FourBytes, vCpu};
        _asmOpcodes["SWAPB" ] = {0xC7, 0x38, FourBytes, vCpu};
        _asmOpcodes["SWAPW" ] = {0xC7, 0x3B, FourBytes, vCpu};
        _asmOpcodes["NEEKA" ] = {0xC7, 0x3E, FourBytes, vCpu};
        _asmOpcodes["NOKEA" ] = {0xC7, 0x41, FourBytes, vCpu};
        _asmOpcodes["ADDVL" ] = {0xC7, 0x44, FourBytes, vCpu};
        _asmOpcodes["SUBVL" ] = {0xC7, 0x47, FourBytes, vCpu};
        _asmOpcodes["ANDVL" ] = {0xC7, 0x4A, FourBytes, vCpu};
        _asmOpcodes["ORVL"  ] = {0xC7, 0x4D, FourBytes, vCpu};
        _asmOpcodes["XORVL" ] = {0xC7, 0x50, FourBytes, vCpu};
        _asmOpcodes["JEQL"  ] = {0xC7, 0x53, FourBytes, vCpu};
        _asmOpcodes["JNEL"  ] = {0xC7, 0x56, FourBytes, vCpu};
        _asmOpcodes["JLTL"  ] = {0xC7, 0x59, FourBytes, vCpu};
        _asmOpcodes["JGTL"  ] = {0xC7, 0x5C, FourBytes, vCpu};
        _asmOpcodes["JLEL"  ] = {0xC7, 0x5F, FourBytes, vCpu};
        _asmOpcodes["JGEL"  ] = {0xC7, 0x62, FourBytes, vCpu};
        _asmOpcodes["ANDBI" ] = {0xC7, 0x65, FourBytes, vCpu};
        _asmOpcodes["ORBI"  ] = {0xC7, 0x68, FourBytes, vCpu};
        _asmOpcodes["XORBI" ] = {0xC7, 0x6B, FourBytes, vCpu};
        _asmOpcodes["ANDBK" ] = {0xC7, 0x6E, FourBytes, vCpu};
        _asmOpcodes["ORBK"  ] = {0xC7, 0x71, FourBytes, vCpu};
        _asmOpcodes["XORBK" ] = {0xC7, 0x74, FourBytes, vCpu};
        _asmOpcodes["JMPI"  ] = {0xC7, 0x77, FourBytes, vCpu};
        _asmOpcodes["SUBIW" ] = {0xC7, 0x7A, FourBytes, vCpu};
        _asmOpcodes["VADDBW"] = {0xC7, 0x7C, FourBytes, vCpu};
        _asmOpcodes["VSUBBW"] = {0xC7, 0x7F, FourBytes, vCpu};
        _asmOpcodes["VADDBL"] = {0xC7, 0x82, FourBytes, vCpu};
        _asmOpcodes["VSUBBL"] = {0xC7, 0x85, FourBytes, vCpu};
        _asmOpcodes["CMPII"]  = {0xC7, 0x88, FourBytes, vCpu};
        ...
        _vcpuOpcodes[0x14] = {0x14, 0x00, TwoBytes,   vCpu, "DEC"   };
        _vcpuOpcodes[0x16] = {0x16, 0x00, ThreeBytes, vCpu, "MOVQB" };
        _vcpuOpcodes[0x18] = {0x18, 0x00, TwoBytes,   vCpu, "LSRB"  };
        _vcpuOpcodes[0x1A] = {0x1A, 0x00, TwoBytes,   vCpu, "LD"    };
        _vcpuOpcodes[0x1C] = {0x1C, 0x00, ThreeBytes, vCpu, "MOVQW" };
        _vcpuOpcodes[0x1F] = {0x1F, 0x00, ThreeBytes, vCpu, "ARRW"  };
        _vcpuOpcodes[0x21] = {0x21, 0x00, TwoBytes,   vCpu, "LDW"   };
        _vcpuOpcodes[0x23] = {0x23, 0x00, TwoBytes,   vCpu, "PEEKV+"};
        _vcpuOpcodes[0x25] = {0x25, 0x00, TwoBytes,   vCpu, "POKEI" };
        ...
        _vcpuOpcodes[0x3D] = {0x3D, 0x00, FourBytes,  vCpu, "ARRVW" };
        _vcpuOpcodes[0x3F] = {0x3F, 0x00, FourBytes,  vCpu, "LDARRW"};
        _vcpuOpcodes[0x42] = {0x42, 0x00, ThreeBytes, vCpu, "ADDVI" };
        _vcpuOpcodes[0x44] = {0x44, 0x00, ThreeBytes, vCpu, "SUBVI" };
        _vcpuOpcodes[0x46] = {0x46, 0x00, TwoBytes,   vCpu, "DEEKV+"};
        _vcpuOpcodes[0x48] = {0x48, 0x00, TwoBytes,   vCpu, "NOTB"  };
        _vcpuOpcodes[0x4A] = {0x4A, 0x00, FourBytes,  vCpu, "DJGE"  };
        _vcpuOpcodes[0x4D] = {0x4D, 0x00, ThreeBytes, vCpu, "LOKEQI"};
        _vcpuOpcodes[0x4F] = {0x4F, 0x00, ThreeBytes, vCpu, "STWM"  };
        _vcpuOpcodes[0x51] = {0x51, 0x00, FourBytes,  vCpu, "STARRW"};
        _vcpuOpcodes[0x53] = {0x53, 0x00, FourBytes,  vCpu, "LDARRB"};
        _vcpuOpcodes[0x55] = {0x55, 0x00, FourBytes,  vCpu, "STARRB"};
        _vcpuOpcodes[0x57] = {0x57, 0x00, FiveBytes,  vCpu, "STARRI"};
        _vcpuOpcodes[0x59] = {0x59, 0x00, TwoBytes,   vCpu, "LDI"   };
        _vcpuOpcodes[0x5B] = {0x5B, 0x00, TwoBytes,   vCpu, "PEEKV" };
        _vcpuOpcodes[0x5E] = {0x5E, 0x00, TwoBytes,   vCpu, "ST"    };
        _vcpuOpcodes[0x60] = {0x60, 0x00, TwoBytes,   vCpu, "DOKEV+"};
        _vcpuOpcodes[0x63] = {0x63, 0x00, OneByte,    vCpu, "POP"   };
        _vcpuOpcodes[0x65] = {0x65, 0x00, ThreeBytes, vCpu, "MOVB"  };
        _vcpuOpcodes[0x67] = {0x67, 0x00, TwoBytes,   vCpu, "PEEKA" };
        _vcpuOpcodes[0x69] = {0x69, 0x00, TwoBytes,   vCpu, "POKEA" };
        _vcpuOpcodes[0x6B] = {0x6B, 0x00, TwoBytes,   vCpu, "TEQ"   };
        _vcpuOpcodes[0x6D] = {0x6D, 0x00, TwoBytes,   vCpu, "TNE"   };
        _vcpuOpcodes[0x6F] = {0x6F, 0x00, TwoBytes,   vCpu, "DEEKA" };
        _vcpuOpcodes[0x72] = {0x72, 0x00, ThreeBytes, vCpu, "LDWM"  };
        _vcpuOpcodes[0x75] = {0x75, 0x00, OneByte,    vCpu, "PUSH"  };
        _vcpuOpcodes[0x77] = {0x77, 0x00, TwoBytes,   vCpu, "SUBBA" };
        _vcpuOpcodes[0x79] = {0x79, 0x00, TwoBytes,   vCpu, "INCW"  };
        _vcpuOpcodes[0x7B] = {0x7B, 0x00, TwoBytes,   vCpu, "DECW"  };
        _vcpuOpcodes[0x7D] = {0x7D, 0x00, TwoBytes,   vCpu, "DOKEA" };
        ...
        _vcpuOpcodes[0x8A] = {0x8A, 0x00, TwoBytes,   vCpu, "PEEKA+"};
        _vcpuOpcodes[0x8C] = {0x8C, 0x00, TwoBytes,   vCpu, "XORI"  };
        _vcpuOpcodes[0x8E] = {0x8E, 0x00, ThreeBytes, vCpu, "DBGE"  };
        _vcpuOpcodes[0x90] = {0x90, 0x00, TwoBytes,   vCpu, "BRA"   };
        _vcpuOpcodes[0x93] = {0x93, 0x00, TwoBytes,   vCpu, "INC"   };
        _vcpuOpcodes[0x95] = {0x95, 0x00, TwoBytes,   vCpu, "INCWA" };
        _vcpuOpcodes[0x97] = {0x97, 0x00, TwoBytes,   vCpu, "POKEA+"};
        _vcpuOpcodes[0x99] = {0x99, 0x00, TwoBytes,   vCpu, "ADDW"  };
        _vcpuOpcodes[0x9C] = {0x9C, 0x00, TwoBytes,   vCpu, "LDNI"  };
        _vcpuOpcodes[0x9E] = {0x9E, 0x00, ThreeBytes, vCpu, "DBNE"  };
        _vcpuOpcodes[0xA0] = {0xA0, 0x00, TwoBytes,   vCpu, "DEEKR" };
        _vcpuOpcodes[0xA2] = {0xA2, 0x00, ThreeBytes, vCpu, "PACKVW"};
        _vcpuOpcodes[0xA4] = {0xA4, 0x00, FourBytes,  vCpu, "DJNE"  };
        _vcpuOpcodes[0xA7] = {0xA7, 0x00, ThreeBytes, vCpu, "CMPI"  };
        _vcpuOpcodes[0xA9] = {0xA9, 0x00, ThreeBytes, vCpu, "ADDVW" };
        _vcpuOpcodes[0xAB] = {0xAB, 0x00, ThreeBytes, vCpu, "SUBVW" };
        ...
        _vcpuOpcodes[0xBB] = {0xBB, 0x00, ThreeBytes, vCpu, "JEQ"   };
        _vcpuOpcodes[0xBD] = {0xBD, 0x00, ThreeBytes, vCpu, "JNE"   };
        _vcpuOpcodes[0xBF] = {0xBF, 0x00, ThreeBytes, vCpu, "JLT"   };
        _vcpuOpcodes[0xC1] = {0xC1, 0x00, ThreeBytes, vCpu, "JGT"   };
        _vcpuOpcodes[0xC3] = {0xC3, 0x00, ThreeBytes, vCpu, "JLE"   };
        _vcpuOpcodes[0xC5] = {0xC5, 0x00, ThreeBytes, vCpu, "JGE"   };
        _vcpuOpcodes[0xCD] = {0xCD, 0x00, TwoBytes,   vCpu, "DEF"   };
        _vcpuOpcodes[0xCF] = {0xCF, 0x00, TwoBytes,   vCpu, "CALL"  };
        _vcpuOpcodes[0xD1] = {0xD1, 0x00, TwoBytes,   vCpu, "POKEV+"};
        _vcpuOpcodes[0xD3] = {0xD3, 0x00, TwoBytes,   vCpu, "LSRV"  };
        _vcpuOpcodes[0xD5] = {0xD5, 0x00, TwoBytes,   vCpu, "TGE"   };
        _vcpuOpcodes[0xD7] = {0xD7, 0x00, TwoBytes,   vCpu, "TLT"   };
        _vcpuOpcodes[0xD9] = {0xD9, 0x00, TwoBytes,   vCpu, "TGT"   };
        _vcpuOpcodes[0xDB] = {0xDB, 0x00, TwoBytes,   vCpu, "TLE"   };
        _vcpuOpcodes[0xDD] = {0xDD, 0x00, TwoBytes,   vCpu, "DECWA" };
        _vcpuOpcodes[0xDF] = {0xDF, 0x00, TwoBytes,   vCpu, "ALLOC" }; 
        _vcpuOpcodes[0xE1] = {0xE1, 0x00, ThreeBytes, vCpu, "SUBBI" };
        ...
        _vbraOpcodes[0x3F] = {OPCODE_V_BCC, 0x3F, ThreeBytes, vCpu, "BEQ"};
        _vbraOpcodes[0x4D] = {OPCODE_V_BCC, 0x4D, ThreeBytes, vCpu, "BGT"};
        _vbraOpcodes[0x50] = {OPCODE_V_BCC, 0x50, ThreeBytes, vCpu, "BLT"};
        _vbraOpcodes[0x53] = {OPCODE_V_BCC, 0x53, ThreeBytes, vCpu, "BGE"};
        _vbraOpcodes[0x56] = {OPCODE_V_BCC, 0x56, ThreeBytes, vCpu, "BLE"};
        _vbraOpcodes[0x72] = {OPCODE_V_BCC, 0x72, ThreeBytes, vCpu, "BNE"};

        // vCPU PREFX1 instructions
        _vcpuOpcodes[0xB111] = {0xB1, 0x11, TwoBytes, vCpu, "NOTE"  };
        _vcpuOpcodes[0xB114] = {0xB1, 0x14, TwoBytes, vCpu, "MIDI"  };
        _vcpuOpcodes[0xB117] = {0xB1, 0x17, TwoBytes, vCpu, "XLA"   };
        _vcpuOpcodes[0xB12F] = {0xB1, 0x2F, TwoBytes, vCpu, "RANDW" };
        _vcpuOpcodes[0xB131] = {0xB1, 0x31, TwoBytes, vCpu, "LDPX"  };
        _vcpuOpcodes[0xB133] = {0xB1, 0x33, TwoBytes, vCpu, "ABSW"  };
        _vcpuOpcodes[0xB136] = {0xB1, 0x36, TwoBytes, vCpu, "SGNW"  };
        _vcpuOpcodes[0xB139] = {0xB1, 0x39, TwoBytes, vCpu, "MULB3" };
        _vcpuOpcodes[0xB13b] = {0xB1, 0x3b, TwoBytes, vCpu, "MULB5" };
        _vcpuOpcodes[0xB13d] = {0xB1, 0x3d, TwoBytes, vCpu, "MULB6" };
        _vcpuOpcodes[0xB13f] = {0xB1, 0x3f, TwoBytes, vCpu, "MULB7" };
        ...
        _vcpuOpcodes[0x2F15] = {0x2F, 0x15, ThreeBytes, vCpu, "NOTW"  };
        _vcpuOpcodes[0x2F17] = {0x2F, 0x17, ThreeBytes, vCpu, "NEGW"  };
        _vcpuOpcodes[0x2F19] = {0x2F, 0x19, ThreeBytes, vCpu, "ANDBA" };
        _vcpuOpcodes[0x2F1C] = {0x2F, 0x1C, ThreeBytes, vCpu, "ORBA"  };
        _vcpuOpcodes[0x2F1F] = {0x2F, 0x1F, ThreeBytes, vCpu, "XORBA" };
        _vcpuOpcodes[0x2F22] = {0x2F, 0x22, ThreeBytes, vCpu, "FREQM" };
        _vcpuOpcodes[0x2F24] = {0x2F, 0x24, ThreeBytes, vCpu, "FREQA" };
        _vcpuOpcodes[0x2F27] = {0x2F, 0x27, ThreeBytes, vCpu, "FREQI" };
        _vcpuOpcodes[0x2F29] = {0x2F, 0x29, ThreeBytes, vCpu, "VOLM"  };
        _vcpuOpcodes[0x2F2C] = {0x2F, 0x2C, ThreeBytes, vCpu, "VOLA"  };
        _vcpuOpcodes[0x2F2F] = {0x2F, 0x2F, ThreeBytes, vCpu, "MODA"  };
        _vcpuOpcodes[0x2F32] = {0x2F, 0x32, ThreeBytes, vCpu, "MODI"  };
        _vcpuOpcodes[0x2F34] = {0x2F, 0x34, ThreeBytes, vCpu, "SMPCPY"};
        _vcpuOpcodes[0x2F37] = {0x2F, 0x37, ThreeBytes, vCpu, "CMPHS" };
        _vcpuOpcodes[0x2F3A] = {0x2F, 0x3A, ThreeBytes, vCpu, "CMPHU" };
        _vcpuOpcodes[0x2F3D] = {0x2F, 0x3D, ThreeBytes, vCpu, "LEEKA" };
        _vcpuOpcodes[0x2F3F] = {0x2F, 0x3F, ThreeBytes, vCpu, "LOKEA" };
        _vcpuOpcodes[0x2F41] = {0x2F, 0x41, ThreeBytes, vCpu, "FEEKA" };
        _vcpuOpcodes[0x2F43] = {0x2F, 0x43, ThreeBytes, vCpu, "FOKEA" };
        _vcpuOpcodes[0x2F45] = {0x2F, 0x45, ThreeBytes, vCpu, "MEEKA" };
        _vcpuOpcodes[0x2F47] = {0x2F, 0x47, ThreeBytes, vCpu, "MOKEA" };
        _vcpuOpcodes[0x2F49] = {0x2F, 0x49, ThreeBytes, vCpu, "LSRVL" };
        _vcpuOpcodes[0x2F4C] = {0x2F, 0x4C, ThreeBytes, vCpu, "LSLVL" };
        _vcpuOpcodes[0x2F4F] = {0x2F, 0x4F, ThreeBytes, vCpu, "INCL"  };
        _vcpuOpcodes[0x2F52] = {0x2F, 0x52, ThreeBytes, vCpu, "DECL"  };
        _vcpuOpcodes[0x2F54] = {0x2F, 0x54, ThreeBytes, vCpu, "STPX"  };
        _vcpuOpcodes[0x2F57] = {0x2F, 0x57, ThreeBytes, vCpu, "FLT6X8"};
        _vcpuOpcodes[0x2F5A] = {0x2F, 0x5A, ThreeBytes, vCpu, "FLT4X6"};
        _vcpuOpcodes[0x2F5C] = {0x2F, 0x5C, ThreeBytes, vCpu, "PRN4X6"};
        _vcpuOpcodes[0x2F5E] = {0x2F, 0x5E, ThreeBytes, vCpu, "VTBL"  };
        _vcpuOpcodes[0x2F61] = {0x2F, 0x61, ThreeBytes, vCpu, "OSCZ"  };

        // vCPU PREFX3 instructions
        _vcpuOpcodes[0xC711] = {0xC7, 0x11, FourBytes, vCpu, "STB2"  };
        _vcpuOpcodes[0xC714] = {0xC7, 0x14, FourBytes, vCpu, "STW2"  };
        _vcpuOpcodes[0xC717] = {0xC7, 0x17, FourBytes, vCpu, "XCHGB" };
        _vcpuOpcodes[0xC719] = {0xC7, 0x19, FourBytes, vCpu, "MOVW"  };
        _vcpuOpcodes[0xC71B] = {0xC7, 0x1B, FourBytes, vCpu, "ADDWI" };
        _vcpuOpcodes[0xC71D] = {0xC7, 0x1D, FourBytes, vCpu, "SUBWI" };
        _vcpuOpcodes[0xC71F] = {0xC7, 0x1F, FourBytes, vCpu, "ANDWI" };
        _vcpuOpcodes[0xC721] = {0xC7, 0x21, FourBytes, vCpu, "ORWI"  };
        _vcpuOpcodes[0xC723] = {0xC7, 0x23, FourBytes, vCpu, "XORWI" };
        _vcpuOpcodes[0xC725] = {0xC7, 0x25, FourBytes, vCpu, "FNT6X8"};
        _vcpuOpcodes[0xC727] = {0xC7, 0x27, FourBytes, vCpu, "FNT4X6"};
        _vcpuOpcodes[0xC729] = {0xC7, 0x29, FourBytes, vCpu, "CONDII"};
        _vcpuOpcodes[0xC72B] = {0xC7, 0x2B, FourBytes, vCpu, "CONDBB"};
        _vcpuOpcodes[0xC72E] = {0xC7, 0x2E, FourBytes, vCpu, "CONDIB"};
        _vcpuOpcodes[0xC731] = {0xC7, 0x31, FourBytes, vCpu, "CONDBI"};
        _vcpuOpcodes[0xC733] = {0xC7, 0x33, FourBytes, vCpu, "XCHGW" };
        _vcpuOpcodes[0xC736] = {0xC7, 0x36, FourBytes, vCpu, "OSCPX" };
        _vcpuOpcodes[0xC738] = {0xC7, 0x38, FourBytes, vCpu, "SWAPB" };
        _vcpuOpcodes[0xC73B] = {0xC7, 0x3B, FourBytes, vCpu, "SWAPW" };
        _vcpuOpcodes[0xC73E] = {0xC7, 0x3E, FourBytes, vCpu, "NEEKA" };
        _vcpuOpcodes[0xC741] = {0xC7, 0x41, FourBytes, vCpu, "NOKEA" };
        _vcpuOpcodes[0xC744] = {0xC7, 0x44, FourBytes, vCpu, "ADDVL" };
        _vcpuOpcodes[0xC747] = {0xC7, 0x47, FourBytes, vCpu, "SUBVL" };
        _vcpuOpcodes[0xC74A] = {0xC7, 0x4A, FourBytes, vCpu, "ANDVL" };
        _vcpuOpcodes[0xC74D] = {0xC7, 0x4D, FourBytes, vCpu, "ORVL"  };
        _vcpuOpcodes[0xC750] = {0xC7, 0x50, FourBytes, vCpu, "XORVL" };
        _vcpuOpcodes[0xC753] = {0xC7, 0x53, FourBytes, vCpu, "JEQL"  };
        _vcpuOpcodes[0xC756] = {0xC7, 0x56, FourBytes, vCpu, "JNEL"  };
        _vcpuOpcodes[0xC759] = {0xC7, 0x59, FourBytes, vCpu, "JLTL"  };
        _vcpuOpcodes[0xC75C] = {0xC7, 0x5C, FourBytes, vCpu, "JGTL"  };
        _vcpuOpcodes[0xC75F] = {0xC7, 0x5F, FourBytes, vCpu, "JLEL"  };
        _vcpuOpcodes[0xC762] = {0xC7, 0x62, FourBytes, vCpu, "JGEL"  };
        _vcpuOpcodes[0xC765] = {0xC7, 0x65, FourBytes, vCpu, "ANDBI" };
        _vcpuOpcodes[0xC768] = {0xC7, 0x68, FourBytes, vCpu, "ORBI"  };
        _vcpuOpcodes[0xC76B] = {0xC7, 0x6B, FourBytes, vCpu, "XORBI" };
        _vcpuOpcodes[0xC76E] = {0xC7, 0x6E, FourBytes, vCpu, "ANDBK" };
        _vcpuOpcodes[0xC771] = {0xC7, 0x71, FourBytes, vCpu, "ORBK"  };
        _vcpuOpcodes[0xC774] = {0xC7, 0x74, FourBytes, vCpu, "XORBK" };
        _vcpuOpcodes[0xC777] = {0xC7, 0x77, FourBytes, vCpu, "JMPI"  };
        _vcpuOpcodes[0xC77A] = {0xC7, 0x7A, FourBytes, vCpu, "SUBIW" };
        _vcpuOpcodes[0xC77C] = {0xC7, 0x7C, FourBytes, vCpu, "VADDBW"};
        _vcpuOpcodes[0xC77F] = {0xC7, 0x7F, FourBytes, vCpu, "VSUBBW"};
        _vcpuOpcodes[0xC782] = {0xC7, 0x82, FourBytes, vCpu, "VADDBL"};
        _vcpuOpcodes[0xC785] = {0xC7, 0x85, FourBytes, vCpu, "VSUBBL"};
        _vcpuOpcodes[0xC788] = {0xC7, 0x88, FourBytes, vCpu, "CMPII" };
    ...
    bool getVCpuMnemonic(uint16_t address, uint8_t opcode, uint8_t operand0, uint8_t operand1, uint8_t operand2, uint8_t operand3, ByteSize& byteSize, char* mnemonic)
    {
        ...
        // Page3 MOVQB MOVB MOVQW MOVWA ADDBI SUBBI CMPI ADDVI SUBVI opcodes
        if(opcode == OPCODE_V_MOVQB  ||  opcode == OPCODE_V_MOVB   ||  opcode == OPCODE_V_MOVQW  ||  opcode == OPCODE_V_MOVWA  ||  opcode == OPCODE_V_ADDBI  ||
           opcode == OPCODE_V_SUBBI  ||  opcode == OPCODE_V_CMPI   ||  opcode == OPCODE_V_ADDVI  ||  opcode == OPCODE_V_SUBVI  ||  opcode == OPCODE_V_PACKVW)
        {
            sprintf(mnemonic, "%04x %-6s $%02x $%02x", address, _vcpuOpcodes[opcode]._mnemonic.c_str(), operand1, operand0);
        }
        // ADDVW SUBVW opcodes
        else if(opcode == OPCODE_V_ADDVW  ||  opcode == OPCODE_V_SUBVW)
        {
        ...
        // DOKEI LOKEQI ARRW opcodes
        else if(opcode == OPCODE_V_DOKEI  ||  opcode == OPCODE_V_LOKEQI  ||  opcode == OPCODE_V_ARRW)
        {
            sprintf(mnemonic, "%04x %-6s $%02x%02x", address, _vcpuOpcodes[opcode]._mnemonic.c_str(), operand0, operand1);
        }
        // LDWM STWM opcodes
                    ...
                    switch(outputSize)
                    {
                        ...
                        case ThreeBytes:
                        {
                            ...
                            else if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_SUBBI)
                            {
                                if(tokens.size() < 3)
                                {
                                    Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'SUBBI <zero page var>, <constant 0..255>' expects 2 parameters '%s'\n", filename.c_str(), _lineNumber+1,
                                                                                                                                                                                        tokens[tokenIndex].c_str());
                                    return false;
                                }
                                ...
                                instruction._operand0 = equates[1]; // native code expects the operands swapped for SUBBI
                                instruction._operand1 = equates[0];
                                _instructions.push_back(instruction);
                                if(!checkInvalidAddress(ParseType(parse), _currentAddress, uint16_t(outputSize), instruction, lineToken, filename, _lineNumber)) return false;
                            }
                            ...
                            else if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_ADDVI)
                            {
                                if(tokens.size() < 3)
                                {
                                    Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'ADDVI <dst zero page var>, <constant 0..255>' expects 2 parameters '%s'\n", filename.c_str(), _lineNumber+1,
                                                                                                                                                                                            tokens[tokenIndex].c_str());
                                    return false;
                                }
                                ...
                                instruction._operand0 = equates[1]; // native code expects the operands swapped for ADDVI
                                instruction._operand1 = equates[0];
                                _instructions.push_back(instruction);
                                if(!checkInvalidAddress(ParseType(parse), _currentAddress, uint16_t(outputSize), instruction, lineToken, filename, _lineNumber)) return false;
                            }
                            ...
                            else if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_ADDVW)
                            {
                                if(tokens.size() < 3)
                                {
                                    Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'ADDVW <src zero page var>, <dst zero page var>' expects 2 parameters '%s'\n", filename.c_str(), _lineNumber+1,
                                                                                                                                                                                              tokens[tokenIndex].c_str());
                                    return false;
                                }
                            ...
                            else if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_SUBVI)
                            {
                                if(tokens.size() < 3)
                                {
                                    Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'SUBVI <dst zero page var>, <constant 0..255>' expects 2 parameters '%s'\n", filename.c_str(), _lineNumber+1,
                                                                                                                                                                                            tokens[tokenIndex].c_str());
                                    return false;
                                }
                                ...
                                instruction._operand0 = equates[1]; // native code expects the operands swapped for SUBVI
                                instruction._operand1 = equates[0];
                                _instructions.push_back(instruction);
                                if(!checkInvalidAddress(ParseType(parse), _currentAddress, uint16_t(outputSize), instruction, lineToken, filename, _lineNumber)) return false;
                            }
                            ...
                            else if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_SUBVW)
                            {
                                if(tokens.size() < 3)
                                {
                                    Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'SUBVW <src zero page var>, <dst zero page var>' expects 2 parameters '%s'\n", filename.c_str(), _lineNumber+1,
                                                                                                                                                                                              tokens[tokenIndex].c_str());
                                    return false;
                                }
                            ...
                            else if(opcodeType == vCpu  &&  opcode0 == OPCODE_V_PACKVW)
                            {
                                if(tokens.size() < 3)
                                {
                                    Cpu::reportError(Cpu::AsmError, stderr, "Assembler::assemble() : '%s:%d' : 'PACKVW <src0 zero page var>, <src1 zero page var>' expects 2 parameters '%s'\n", filename.c_str(), _lineNumber+1,
                                                                                                                                                                                                 tokens[tokenIndex].c_str());
                                    return false;
                                }
                                ...
                                instruction._operand0 = equates[1]; // native code expects the operands swapped for PACKVW
                                instruction._operand1 = equates[0];
                                _instructions.push_back(instruction);
                                if(!checkInvalidAddress(ParseType(parse), _currentAddress, uint16_t(outputSize), instruction, lineToken, filename, _lineNumber)) return false;
                            }
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    // DOKEI and LOKEQI have their operands swapped
                                    if(opcodeType == vCpu  &&  (opcode0 == OPCODE_V_DOKEI  ||  opcode0 == OPCODE_V_LOKEQI))
                                    {
