...
namespace Assembler
{
    ...
    void initialiseOpcodes(void)
    {
        ...
        _asmOpcodes["PRN4X6"] = {0x2F, 0x57, ThreeBytes, vCpu};
        _asmOpcodes["VTBL"  ] = {0x2F, 0x59, ThreeBytes, vCpu};
        _asmOpcodes["OSCZ"  ] = {0x2F, 0x5c, ThreeBytes, vCpu};
        ...
        _asmOpcodes["FNT4X6"] = {0xC7, 0x28, FourBytes, vCpu};
        _asmOpcodes["CONDII"] = {0xC7, 0x2A, FourBytes, vCpu};
        _asmOpcodes["CONDBB"] = {0xC7, 0x2C, FourBytes, vCpu};
        _asmOpcodes["CONDIB"] = {0xC7, 0x2F, FourBytes, vCpu};
        _asmOpcodes["CONDBI"] = {0xC7, 0x32, FourBytes, vCpu};
        _asmOpcodes["XCHGW" ] = {0xC7, 0x34, FourBytes, vCpu};
        _asmOpcodes["OSCPX" ] = {0xC7, 0x37, FourBytes, vCpu};
        _asmOpcodes["SWAPB" ] = {0xC7, 0x39, FourBytes, vCpu};
        _asmOpcodes["SWAPW" ] = {0xC7, 0x3C, FourBytes, vCpu};
        _asmOpcodes["NEEKA" ] = {0xC7, 0x3F, FourBytes, vCpu};
        _asmOpcodes["NOKEA" ] = {0xC7, 0x42, FourBytes, vCpu};
        _asmOpcodes["ADDVL" ] = {0xC7, 0x45, FourBytes, vCpu};
        _asmOpcodes["SUBVL" ] = {0xC7, 0x48, FourBytes, vCpu};
        _asmOpcodes["ANDVL" ] = {0xC7, 0x4B, FourBytes, vCpu};
        _asmOpcodes["ORVL"  ] = {0xC7, 0x4E, FourBytes, vCpu};
        _asmOpcodes["XORVL" ] = {0xC7, 0x51, FourBytes, vCpu};
        _asmOpcodes["JEQL"  ] = {0xC7, 0x54, FourBytes, vCpu};
        _asmOpcodes["JNEL"  ] = {0xC7, 0x57, FourBytes, vCpu};
        _asmOpcodes["JLTL"  ] = {0xC7, 0x5A, FourBytes, vCpu};
        _asmOpcodes["JGTL"  ] = {0xC7, 0x5D, FourBytes, vCpu};
        _asmOpcodes["JLEL"  ] = {0xC7, 0x60, FourBytes, vCpu};
        _asmOpcodes["JGEL"  ] = {0xC7, 0x63, FourBytes, vCpu};
        _asmOpcodes["ANDBI" ] = {0xC7, 0x66, FourBytes, vCpu};
        _asmOpcodes["ORBI"  ] = {0xC7, 0x69, FourBytes, vCpu};
        _asmOpcodes["XORBI" ] = {0xC7, 0x6C, FourBytes, vCpu};
        _asmOpcodes["ANDBK" ] = {0xC7, 0x6F, FourBytes, vCpu};
        _asmOpcodes["ORBK"  ] = {0xC7, 0x72, FourBytes, vCpu};
        _asmOpcodes["XORBK" ] = {0xC7, 0x75, FourBytes, vCpu};
        _asmOpcodes["JMPI"  ] = {0xC7, 0x78, FourBytes, vCpu};
        _asmOpcodes["SUBIW" ] = {0xC7, 0x7B, FourBytes, vCpu};
        _asmOpcodes["VADDBW"] = {0xC7, 0x7D, FourBytes, vCpu};
        _asmOpcodes["VSUBBW"] = {0xC7, 0x80, FourBytes, vCpu};
        ...
        _vcpuOpcodes[0x2F57] = {0x2F, 0x57, ThreeBytes, vCpu, "PRN4X6"};
        _vcpuOpcodes[0x2F59] = {0x2F, 0x59, ThreeBytes, vCpu, "VTBL"  };
        _vcpuOpcodes[0x2F5C] = {0x2F, 0x5C, ThreeBytes, vCpu, "OSCZ"  };
        ...
        _vcpuOpcodes[0xC728] = {0xC7, 0x28, FourBytes, vCpu, "FNT4X6"};
        _vcpuOpcodes[0xC72A] = {0xC7, 0x2A, FourBytes, vCpu, "CONDII"};
        _vcpuOpcodes[0xC72C] = {0xC7, 0x2C, FourBytes, vCpu, "CONDBB"};
        _vcpuOpcodes[0xC72F] = {0xC7, 0x2F, FourBytes, vCpu, "CONDIB"};
        _vcpuOpcodes[0xC732] = {0xC7, 0x32, FourBytes, vCpu, "CONDBI"};
        _vcpuOpcodes[0xC734] = {0xC7, 0x34, FourBytes, vCpu, "XCHGW" };
        _vcpuOpcodes[0xC737] = {0xC7, 0x37, FourBytes, vCpu, "OSCPX" };
        _vcpuOpcodes[0xC739] = {0xC7, 0x39, FourBytes, vCpu, "SWAPB" };
        _vcpuOpcodes[0xC73C] = {0xC7, 0x3C, FourBytes, vCpu, "SWAPW" };
        _vcpuOpcodes[0xC73F] = {0xC7, 0x3F, FourBytes, vCpu, "NEEKA" };
        _vcpuOpcodes[0xC742] = {0xC7, 0x42, FourBytes, vCpu, "NOKEA" };
        _vcpuOpcodes[0xC745] = {0xC7, 0x45, FourBytes, vCpu, "ADDVL" };
        _vcpuOpcodes[0xC748] = {0xC7, 0x48, FourBytes, vCpu, "SUBVL" };
        _vcpuOpcodes[0xC74B] = {0xC7, 0x4B, FourBytes, vCpu, "ANDVL" };
        _vcpuOpcodes[0xC74E] = {0xC7, 0x4E, FourBytes, vCpu, "ORVL"  };
        _vcpuOpcodes[0xC751] = {0xC7, 0x51, FourBytes, vCpu, "XORVL" };
        _vcpuOpcodes[0xC754] = {0xC7, 0x54, FourBytes, vCpu, "JEQL"  };
        _vcpuOpcodes[0xC757] = {0xC7, 0x57, FourBytes, vCpu, "JNEL"  };
        _vcpuOpcodes[0xC75A] = {0xC7, 0x5A, FourBytes, vCpu, "JLTL"  };
        _vcpuOpcodes[0xC75D] = {0xC7, 0x5D, FourBytes, vCpu, "JGTL"  };
        _vcpuOpcodes[0xC760] = {0xC7, 0x60, FourBytes, vCpu, "JLEL"  };
        _vcpuOpcodes[0xC763] = {0xC7, 0x63, FourBytes, vCpu, "JGEL"  };
        _vcpuOpcodes[0xC766] = {0xC7, 0x66, FourBytes, vCpu, "ANDBI" };
        _vcpuOpcodes[0xC769] = {0xC7, 0x69, FourBytes, vCpu, "ORBI"  };
        _vcpuOpcodes[0xC76C] = {0xC7, 0x6C, FourBytes, vCpu, "XORBI" };
        _vcpuOpcodes[0xC76F] = {0xC7, 0x6F, FourBytes, vCpu, "ANDBK" };
        _vcpuOpcodes[0xC772] = {0xC7, 0x72, FourBytes, vCpu, "ORBK"  };
        _vcpuOpcodes[0xC775] = {0xC7, 0x75, FourBytes, vCpu, "XORBK" };
        _vcpuOpcodes[0xC778] = {0xC7, 0x78, FourBytes, vCpu, "JMPI"  };
        _vcpuOpcodes[0xC77B] = {0xC7, 0x7B, FourBytes, vCpu, "SUBIW" };
        _vcpuOpcodes[0xC77D] = {0xC7, 0x7D, FourBytes, vCpu, "VADDBW"};
        _vcpuOpcodes[0xC780] = {0xC7, 0x80, FourBytes, vCpu, "VSUBBW"};
