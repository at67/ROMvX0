...
namespace Expression
{
    ...
    struct Numeric
    {
        Numeric()
        {
            _value = 0.0; _index = -1; _isValid = false; _staticInit = false; _relocatable = false; _varType = Number; _condCode = {false, BooleanCC}; _int16Byte = Int16Both; _name = ""; _text = "";
        }
        ...
        Numeric(double value, int16_t index, bool isValid, bool staticInit, bool relocatable, VarType varType, const CondCode& condCode, Int16Byte int16Byte, const std::string& name, const std::string& text)
        {
            _value = value; _index = index; _isValid = isValid; _staticInit = staticInit; _relocatable = relocatable; _varType = varType; _condCode = condCode; _int16Byte = int16Byte; _name = name; _text = text;
        }
    ...
    std::string getVasmOperand(const std::string& operand, int index=0);
    ...
    int replaceText(std::string& inout, const std::string& text, const std::string& replace, size_t offset=0);
