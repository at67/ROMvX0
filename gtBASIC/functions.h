...
namespace Functions
{
    ...
    Expression::Numeric LCASE$(Expression::Numeric& numeric,  const std::string& moduleName, const std::string& codeLineText, int codeLineIndex);
    Expression::Numeric UCASE$(Expression::Numeric& numeric,  const std::string& moduleName, const std::string& codeLineText, int codeLineIndex);
